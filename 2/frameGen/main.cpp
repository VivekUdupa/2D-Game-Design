...
/*
	...
	SDL_Point centerS2 = {180, 100};
	DrawFilledSemiCircle semi2(renderer, centerS2, 90, color1, WIDTH, HEIGHT);
	semi2.draw();
	
	SDL_Point centerS = {100, 100};
	DrawFilledSemiCircle semi1(renderer, centerS, 50, color2, WIDTH, HEIGHT);
	semi1.draw();
